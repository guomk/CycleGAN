...
parser.add_argument('--size', type=int, default=110, help='size of the data crop (squared assumed)')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    for i, batch in enumerate(dataloader):
        ...
        logger.log({'loss_G': loss_G, 'loss_G_identity': (loss_identity_A + loss_identity_B), 'loss_G_GAN': (loss_GAN_A2B + loss_GAN_B2A),
                    ...
                    images={'real_A': real_A, 'fake_B': fake_B, 'recovered_A': recovered_A, 'real_B': real_B, 'fake_A': fake_A, 'recovered_B': recovered_B})
